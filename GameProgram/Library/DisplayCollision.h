...
#define _COLLISION_LINE_ON 
	...
	public:
		...
		void AddBox(
			...
			const DirectX::SimpleMath::Color& lineColor = DirectX::SimpleMath::Color(1.0f, 1.0f, 1.0f));

		void AddSphere(const DirectX::SimpleMath::Vector3& center, float radius, const DirectX::SimpleMath::Color& lineColor);
	};
